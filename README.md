# Rust API client for ziti_edge_management_api
...
- API version: 0.26.52
- Package version: 0.26.52
- Generator version: 7.14.0
- Build package: `org.openapitools.codegen.languages.RustClientCodegen`

## Installation

Put the package under your project folder in a directory named `ziti_edge_management_api` and add the following to `Cargo.toml` under `[dependencies]`:

```
ziti_edge_management_api = { path = "./ziti_edge_management_api" }
```
