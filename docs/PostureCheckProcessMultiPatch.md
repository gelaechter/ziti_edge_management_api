...
**type_id** | [**models::PostureCheckType**](postureCheckType.md) |  | 
**processes** | Option<[**Vec<models::ProcessMulti>**](processMulti.md)> |  | [optional]
**semantic** | Option<[**models::Semantic**](semantic.md)> |  | [optional]
